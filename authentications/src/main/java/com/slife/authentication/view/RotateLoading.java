...
public class RotateLoading extends View {
    ...
    private void initView(Context context, AttributeSet attrs) {
        color = getResources().getColor(R.color.blue_load);
        ...
        if (null != attrs) {
            ...
            color = typedArray.getColor(R.styleable.RotateLoading_loading_color, getResources().getColor(R.color.blue_load));
